...
function(adlplug_pgo_train)
  ...
  foreach(variable IN LISTS cache_variables)
    if(variable MATCHES "^(CMAKE_(C|CXX|RC)_COMPILER|CMAKE_MAKE_PROGRAM|CMAKE_LINKER_TYPE|CMAKE_(AR|RANLIB|NM|OBJCOPY|OBJDUMP|STRIP|READELF|ADDR2LINE|DLLTOOL)|CMAKE_(EXE|SHARED|MODULE)_LINKER_FLAGS|CMAKE_OSX_[A-Z_]+|ADLplug_(CHIP|ARCH|ASSERTIONS|WERROR|GREYZONE_BANKS|ASIO|LV2|AU|AAX|Standalone|PRESET)|USE_[A-Z0-9_]+_EMULATOR)$")
